...
dependencies {
    ...
    // Explicit rather than relied on transitively through material3: a
    // navigation drawer and a breadcrumb rail are made of icons, and an
    // icon dependency that arrives by accident disappears by accident.
